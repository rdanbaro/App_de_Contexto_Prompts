...
import database
from Modelo.modelos import Contexto, Usuario
from Vistas.ui_vista_main import Ui_vista_main

# Clase ControlandoraVistaPrincipal que hereda de QMainWindow y Ui_vista_main
class ControlandoraVistaPrincipal(QMainWindow, Ui_vista_main):
    def __init__(self):
        ...
        # Configuración de la interfaz y conexión de señales
    ...
    def anadir(self):
        try:
            # Obtener el título y el usuario activo
            ...
            # Validar el título y el contenido del prompt
            if titulo_prompt == '':
                ...
                if buscando_existencia_contexto == None:
                    # Agregar el contexto a la base de datos
                    ...
                    # Crear un nuevo botón para el prompt y añadirlo a la lista de botones
    ...
    def borrar(self):
        # Obtener el nombre del contexto a borrar
        nombre_contexto = self.boton_seleccionado.nombre_contexto_vinculado

        # Buscar el contexto en la base de datos
        usuario_activo = database.sesion.query(Usuario).filter(
            Usuario.sesion_iniciada == True
        ).first()
        ...
        # Eliminar el contexto de la base de datos
    ...
    def mostrar_prompts_guardados(self):
        ...
        # Obtener todos los contextos del usuario activo
        ...
        if contextos_usuario_activo is not None:
            for i in contextos_usuario_activo:
                # Crear un botón para cada contexto y añadirlo a la lista de botones
...
# Clase BotonEspecialPrompt que hereda de QPushButton
